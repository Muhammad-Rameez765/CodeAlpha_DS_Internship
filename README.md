...
Outcome: Achieved a 90% R-squared score, identifying Radio as the most efficient ROI driver and TV as the highest volume driver.
...
Data Cleaning: Real-world data is messy; I learned to handle missing values and outliers effectively.

Model Selection: Understanding when to use Regression vs. Classification.

Evaluation: Using metrics like MAE, RMSE, Accuracy, and F1-Score to validate model reliability.

Communication: Presenting technical findings as actionable business insights.

## 🤝 Connect with Me
GitHub: Muhammad-Rameez765

Kaggle: https://www.kaggle.com/mr1rameez
